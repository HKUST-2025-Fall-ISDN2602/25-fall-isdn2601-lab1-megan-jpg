...
#define Vout 32  //*** Define the GPIO pin 32 as Vout ***
...
void setup() {
  ...
  for (int onPeriod = 0; onPeriod < 256; onPeriod++) 
    ...
    c1 = float(Vout_value*3.3f)/4095.0f ; // convert 12 bit binary number of Voltage level at Vout back to 0-3.3 V 
    c2 = float(c_value*3.3f)/4095.0f ; // convert 12 bit binary number of Voltage level at D14 back to 0-3.3 V 
    x =  (c1)*1000.0f; // calculate the voltage at Vout in mV
